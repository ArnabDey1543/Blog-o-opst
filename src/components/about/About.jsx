            ...
            <Wrapper>
                ...
                <Text variant="h5">I'm a Software Engineer based in India. 
                    ...
                    <Box component="span" style={{ marginLeft: 5 }}>
                        <Link href="https://github.com/kumar1508" color="inherit" target="_blank"><GitHub /></Link>
                    </Box>
                </Text>
                <Text variant="h5">
                    ...
                    <Box component="span" style={{ marginLeft: 5 }}>
                        ...
                        or send me an Email 
                        <Link href="mailto:kumarsashwat30@gmail.com?Subject=This is a subject" target="_blank" color="inherit">
                            <Email />
                        </Link>.
                </Text>
            </Wrapper>
